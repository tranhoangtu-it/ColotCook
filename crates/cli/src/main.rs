...
use colotcook_runtime::{
    load_system_prompt,
    resolve_sandbox_status, ApiClient,
    ApiRequest, AssistantEvent, CompactionConfig, ConfigLoader, ContentBlock,
    ConversationMessage, ConversationRuntime, McpServerManager, MessageRole,
    PermissionMode, PermissionPolicy, PromptCacheEvent, RuntimeError, Session,
    ToolError, ToolExecutor, UsageTracker,
};
use colotcook_tools::{GlobalToolRegistry, McpBridge};
use oauth_flow::{resolve_cli_auth_source, run_login, run_logout};
use reports::{
...
use tool_display::{format_tool_call_start, format_tool_result};
...
use util::{
    extract_tool_path, first_visible_line, git_output,
...
// StatusContext, StatusUsage, GitWorkspaceSummary moved to reports.rs


// format_model_report moved to reports.rs

// format_model_switch_report moved to reports.rs

// Reports block (format_permissions_report through parse_git_status_metadata_for) moved to reports.rs
...
// render_repl_help moved to reports.rs

// format_status_report moved to reports.rs
...
struct MultiProviderRuntimeClient {
